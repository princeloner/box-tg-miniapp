...
export const RainbowCase: React.FC<RainbowCaseProps> = ({ isOpening, balance, cost, onOpen }) => {
    ...
    <div className="p-4">
      <div className="text-center mb-4">
        <div className="text-gray-400 h-6 relative overflow-hidden" style={{
          ...
          >
            {isEnglish ? 'Rainbow Case' : 'Радужный кейс'}
          </div>
        </div>
        <div className="text-gray-400 h-6 relative overflow-hidden mt-4" style={{
          ...
          >
            {isEnglish ? 'Infinity case' : 'кейс бесконечный'}
          </div>
        </div>
      </div>
